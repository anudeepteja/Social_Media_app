    ...
    return(
      <>
        <div className="birthdayContainer">
          ...
          <span className="birthdayText"> <b>pola foster</b> and <b>other 3 friends</b> have a birthday today</span>
        </div>
    ...
    return (
      <>
        {(user.username !== currentUser.username) && (
          <button className="rightbarFollowButton" onClick={hangleClick}>
